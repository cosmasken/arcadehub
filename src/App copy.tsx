...
const WalletConnector = () => {
  const { walletState, initializeWeb3Auth, connectWallet, disconnectWallet } = useWalletStore();
        ...
        <div className="wallet-connected-info">
          <div className="wallet-info">
            <span className="wallet-address">
              {walletState.userAddress.substring(0, 6)}...
              {walletState.userAddress.substring(walletState.userAddress.length - 4)}
            </span>
          ...
          {walletState.aaWalletAddress && (
            <div className="aa-wallet-info">
              ...
              <span className="aa-wallet-address">
                {walletState.aaWalletAddress.substring(0, 6)}...
                {walletState.aaWalletAddress.substring(walletState.aaWalletAddress.length - 4)}
              </span>
              <button
